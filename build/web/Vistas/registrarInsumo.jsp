...
<head>
    ...
    <title>Registrar Insumo - PERU-ROAD</title>
        ...
        <div class="content-area">
            <div class="form-container">
                <div class="page-header">
                    <h1 class="page-title">Registrar Nuevo Insumo/Repuesto</h1>
                    <p class="page-subtitle">Complete la información del nuevo artículo para el almacén</p>
                </div>
                ...
                <form action="../RegistrarRepuestoServlet" method="post" onsubmit="return validarFormulario()">
                    <div class="form-row">
                        <div class="form-group">
                            <label>Código <span class="required">*</span></label>
                            <input type="text" name="codigo" id="codigo" required placeholder="Ej: FLT-001">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="text" name="descripcion" id="descripcion" required placeholder="Descripción detallada del repuesto">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="precioPromedio" id="precioPromedio" step="0.01" min="0" required placeholder="0.00">
                        </div>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label>Cantidad Inicial <span class="required">*</span></label>
                            <input type="number" name="cantidadActual" id="cantidadActual" min="0" required placeholder="0">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="idAlmacen" id="idAlmacen" required>
                                ...
                                <option value="2">Almacén Norte - Principal</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="stockMinimo" id="stockMinimo" min="0" required placeholder="0">
                        </div>
                        <div class="form-group">
                            <label>Stock Máximo <span class="required">*</span></label>
                            <input type="number" name="stockMaximo" id="stockMaximo" min="0" required placeholder="0">
                        </div>
                    </div>
